          ...
          <div className="flex items-center justify-between px-6 py-3">
             ...
             <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={cn(
                      "p-2 rounded-lg transition-colors border",
                      showTimestamps ? "bg-accent/10 border-accent/20 text-accent" : "bg-bg-tertiary border-border/50 text-text-muted hover:text-white"
                  )}
                ...
                <button
                  ...
                  className={cn(
                      "p-2 rounded-lg transition-colors border",
                      isAtBottom ? "bg-bg-tertiary border-border/50 text-text-muted" : "bg-accent/10 border-accent/20 text-accent"
                  )}
                ...
                <button
                  onClick={closeConsole}
                  className="ml-2 p-2 text-text-muted hover:text-white transition-all"
                  title="Close console"
                >
                  <X className="w-6 h-6" />
                </button>
